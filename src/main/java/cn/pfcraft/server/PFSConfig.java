...
public class PFSConfig {
    ...
    private static final String HEADER = "This is the main configuration file for PFServer.";
    /*========================================================================*/
    ...
    public static void init(File configFile) {
        ...
        readConfig(PFSConfig.class, null);
    }
    ...
    static void readConfig(Class<?> clazz, Object instance) {
            ...
            if (Modifier.isPrivate(method.getModifiers())) {
                if (method.getParameterTypes().length == 0 && method.getReturnType() == Void.TYPE) {
                    try {
                        ...
                        PFServer.LOGGER.error("Error invoking " + method, ex);
                    }
                }
            }
        }
        ...
        try {
            ...
            PFServer.LOGGER.error("Could not save " + CONFIG_FILE, ex);
        }
    }
