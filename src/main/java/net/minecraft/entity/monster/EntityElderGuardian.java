...
public class EntityElderGuardian extends EntityGuardian
{
    ...
    protected void updateAITasks()
    {
        ...
        if ((this.ticksExisted + this.getEntityId()) % 1200 == 0)
        {
            ...
            List<EntityPlayerMP> list = this.world.<EntityPlayerMP>getPlayers(EntityPlayerMP.class, p_apply_1_ -> EntityElderGuardian.this.getDistanceSq(p_apply_1_) < 2500.0D && p_apply_1_.interactionManager.survivalOrAdventure());
            int j = 2;
            int k = 6000;
            int l = 1200;
