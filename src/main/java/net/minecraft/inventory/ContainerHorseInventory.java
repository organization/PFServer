...
public class ContainerHorseInventory extends Container
{
    ...
    public InventoryView getBukkitView() {
        ...
        return bukkitEntity = (horseInventory.getOwner() != null ? new CraftInventoryView(player.player.getBukkitEntity(), horseInventory.getOwner().getInventory(), this) : null); // PFServer
    }
