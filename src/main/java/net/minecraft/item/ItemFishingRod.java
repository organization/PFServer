    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                PlayerFishEvent playerFishEvent = new PlayerFishEvent((org.bukkit.entity.Player) playerIn.getBukkitEntity(), null, (org.bukkit.entity.FishHook) entityfishhook.getBukkitEntity(), PlayerFishEvent.State.FISHING);
