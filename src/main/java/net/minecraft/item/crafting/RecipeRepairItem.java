    ...
    public ItemStack getCraftingResult(InventoryCrafting inv)
    {
        ...
        if (list.size() == 2)
        {
            ...
            if (itemstack2.getItem() == itemstack3.getItem() && itemstack2.getCount() == 1 && itemstack3.getCount() == 1 && itemstack2.getItem().isRepairable())
            {
                ...
                if(inv.eventHandler.getBukkitView() != null) result = org.bukkit.craftbukkit.event.CraftEventFactory.callPreCraftEvent(inv, result, inv.eventHandler.getBukkitView(), true);
                return result;
