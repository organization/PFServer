    ...
    public void processVehicleMove(CPacketVehicleMove packetIn)
    {
        ...
        else
        {
            ...
            if (entity != this.player && entity.getControllingPassenger() == this.player && entity == this.lowestRiddenEnt)
            {
                ...
                this.player.setPositionAndRotation(d3, d4, d5, this.player.yaw, this.player.pitch); // Forge - Resync player position on vehicle moving
                ...
                if (flag && (flag1 || !flag2))
                {
                    ...
                    this.player.setPositionAndRotation(d0, d1, d2, this.player.yaw, this.player.pitch); // Forge - Resync player position on vehicle moving
                    this.netManager.sendPacket(new SPacketMoveVehicle(entity));
                    return;
                }
