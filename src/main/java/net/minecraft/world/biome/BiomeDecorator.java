...
public class BiomeDecorator
{
    ...
    public final WorldGenerator clayGen = new WorldGenClay(4);
    public final WorldGenerator sandGen = new WorldGenSand(Blocks.SAND, 7);
    public final WorldGenerator gravelGen = new WorldGenSand(Blocks.GRAVEL, 6);
    ...
    public final WorldGenFlowers flowerGen = new WorldGenFlowers(Blocks.YELLOW_FLOWER, BlockFlower.EnumFlowerType.DANDELION);
    public final WorldGenerator mushroomBrownGen = new WorldGenBush(Blocks.BROWN_MUSHROOM);
    public final WorldGenerator mushroomRedGen = new WorldGenBush(Blocks.RED_MUSHROOM);
    public final WorldGenerator bigMushroomGen = new WorldGenBigMushroom();
    public final WorldGenerator reedGen = new WorldGenReed();
    public final WorldGenerator cactusGen = new WorldGenCactus();
    public final WorldGenerator waterlilyGen = new WorldGenWaterlily();
