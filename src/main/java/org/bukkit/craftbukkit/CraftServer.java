...
public final class CraftServer implements Server {
    ...
    public void reload() {
        ...
        EnumDifficulty difficulty = EnumDifficulty.getDifficultyEnum(config.getIntProperty("difficulty", console.worlds[0].getDifficulty().ordinal()));
    ...
    public World getWorld(String name) {
        Validate.notNull(name, "Name cannot be null");
        // if the world does not exist, try load it from Forge
    ...
    static CraftIconCache loadServerIcon0(BufferedImage image) throws Exception {
        ...
        return new CraftIconCache("data:image/png;base64," + bytebuf1.toString(Charsets.UTF_8).replace("/n", ""));
    }
