    ...
    public HelpYamlReader(Server server) {
        ...
        try {
            ...
            try {
                ...
                server.getLogger().error("Could not save " + helpYamlFile, ex);
            }
        } catch (Exception ex) {
            server.getLogger().error("Failed to load help.yml. Verify the yaml indentation is correct. Reverting to default help.yml.");
