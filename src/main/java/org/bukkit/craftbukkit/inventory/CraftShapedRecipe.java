...
public class CraftShapedRecipe extends ShapedRecipe implements CraftRecipe {
    ...
    public CraftShapedRecipe(ItemStack result, ShapedRecipes recipe) {
        this(recipe.key != null ? CraftNamespacedKey.fromMinecraft(recipe.key) : NamespacedKey.randomKey(), result); // PFServer - if key is null, use random key
        this.recipe = recipe;
    }
